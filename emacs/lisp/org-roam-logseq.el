...
;; Adapted by fap
;;
;; Caution: Your the content of your first block in LogSeq becomes your title in org-roam,
...
(defvar bill/logseq-folder (f-expand (f-join org-roam-directory "notes")))
